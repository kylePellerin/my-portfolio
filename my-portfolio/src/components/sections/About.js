    ...
    <div className={styles.aboutPageContainer}>
      ...
      <section className={`${styles.aboutSection} ${styles.detailsSection}`}>
        ...
        <div className={styles.textBlock}>
          ...
          <p>
            I love to pursue my various hobbies and interests. At Bowdoin I was the captain of the Club Alpine Ski Team, a sport I have competed in since I was ten years old. I also love skiing for fun and have recently started to get more into touring and backcountry as well. At home, I love working on my family's farm, taking care of the animals and growing plants (specifically hot peppers). I also have a great passion for cooking and love to prepare dishes from around the world using what we grow in the warmer months. When I’m not skiing, farming, or cooking, I love to fish, lift, DJ, hike and camp. I always love going on adventures and sharing what I love with my peers. 
          </p>
        </div>
      </section>
    </div>
